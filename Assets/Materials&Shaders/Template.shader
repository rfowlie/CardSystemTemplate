...
Shader "Template"
{
	Properties
	{
		...
		[ASEEnd]_Sharpness("Sharpness", Range( 0 , 1)) = 0.85
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				if( ( 1.0 - tex2DNode7.r ) > _Sharpness )
				ifLocalVar11 = 1.0;
				float temp_output_12_0 = ( tex2DNode7.a * ifLocalVar11 );
				
				float3 Albedo = ( _Colour * temp_output_12_0 ).rgb;
...
/*ASEBEGIN
Version=18500
519;73;1010;609;2078.286;312.3266;2.182917;True;False
Node;AmplifyShaderEditor.TexturePropertyNode;6;-1713.972,-117.454;Inherit;True;Property;_MainTex;_MainTex;0;0;Create;True;0;0;False;0;False;fce461027a69b2b47bc8e5e3b9ff1ce0;fce461027a69b2b47bc8e5e3b9ff1ce0;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;7;-1472.563,-118.1287;Inherit;True;Property;_TextureSample1;Texture Sample 0;1;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;8;-1085.614,132.6272;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;9;-1196.645,366.634;Inherit;False;Property;_Sharpness;Sharpness;2;0;Create;True;0;0;False;0;False;0.85;0.908;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-1092.382,594.0406;Inherit;False;Constant;_Float0;Float 0;2;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ConditionalIfNode;11;-859.202,131.9981;Inherit;False;False;5;0;FLOAT;0;False;1;FLOAT;0.9;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-581.288,-8.049469;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;14;-603.4568,-313.7059;Inherit;False;Property;_Colour;Colour;1;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-314.0987,-259.2454;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=27C15AD38B7CF372F5B73648C6841C1F45C56CDB